...
const ColorPicker = ({ color, opacity, onColorChange, onOpacityChange }) => {
  ...
  return (
    <section className="fixed bottom-24 left-1/2 z-40 w-[min(320px,calc(100vw-1rem))] -translate-x-1/2 rounded-2xl border border-slate-200 bg-white p-5 shadow-2xl">
      ...
      <div className="mt-4 grid grid-cols-[5.25rem_1fr_3.5rem] gap-3">
        ...
        <label className="flex min-h-11 items-center gap-2 rounded-md border border-slate-200 bg-white px-3 focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2">
          <span
        ...
        <label className="flex min-h-11 items-center rounded-md border border-slate-200 bg-white px-2 focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2">
